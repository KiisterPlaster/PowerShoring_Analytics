...
model: inherit
skills: clean-architecture, clean-code, distributed-systems, security-hardening, devops-foundations, cloud-architecture, domain-driven-design, event-driven-systems, nodejs-best-practices, python-patterns, api-design, api-patterns, database-design, ai-backend-patterns, observability, mcp-builder, lint-and-validate, powershell-windows, bash-linux
---
